...
using namespace androidgui::globals;
androidgui::functions_t androidgui::functions;
androidgui::gui_window_context_t androidgui::globals::window_ctx;

// ========================================================================
bool androidgui::button(const char* id, const vec2 size) {
    ...
    window_ctx.render.emplace_back(androidgui_control_render_t{ {draw_pos.x + size.x / 2 - text_width / 2, draw_pos.y + size.y / 2 - text_height / 2}, androidgui_render_type::androidgui_text, global_colors.color_text, id_split[0], vec2{0, 0}, font });
    window_ctx.render.emplace_back(androidgui_control_render_t{ {draw_pos.x + 1, draw_pos.y + 1}, androidgui_render_type::androidgui_filled_rect, active ? global_colors.control_active_or_clicked : global_colors.control_idle, "", {size.x - 2, size.y - 2} });
    window_ctx.render.emplace_back(androidgui_control_render_t{ {draw_pos.x, draw_pos.y}, androidgui_render_type::androidgui_filled_rect, global_colors.control_outline, "", size });
...
void androidgui::MiniBox(const char* id) {
    std::vector<std::string> id_split = utils::hash::split_str(id, '#');
    ...
    functions.draw_filled_rect(cursor_position.x + 15, cursor_position.y + 15, text_width + 6, text_height + 6, { 20, 20, 20, 255 });
    window_ctx.render.emplace_back(androidgui_control_render_t{ {cursor_position.x + 18, cursor_position.y + 18}, androidgui_render_type::androidgui_text, global_colors.color_text, id_split[0], vec2{0, 0}, font });
...
bool androidgui::TextHoverable(const char* id) {
    std::vector<std::string> id_split = utils::hash::split_str(id, '#');
    ...
    window_ctx.render.emplace_back(androidgui_control_render_t{ {draw_pos.x, draw_pos.y}, androidgui_render_type::androidgui_text, global_colors.color_text, id_split[0], vec2{0, 0}, font });
...
// ========================================================================
bool androidgui::Lineee(const vec2 size, const bool invisible) {
    ...
    if (invisible) {
        const vec2 draw_pos{ window_ctx.position.x + cursor_pos.x, window_ctx.position.y + cursor_pos.y };
        window_ctx.render.emplace_back(androidgui_control_render_t{ {draw_pos.x + 1, draw_pos.y + 1}, androidgui_render_type::androidgui_filled_rect, global_colors.control_active_or_clicked, "", {size.x - 2, size.y - 2} });
    }
...
// ========================================================================
void androidgui::checkbox(const char *id, bool &value) {
    std::vector<std::string> id_split = utils::hash::split_str(id, '#');
    ...
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 14, draw_pos.y - 2}, androidgui_render_type::androidgui_text, value ? global_colors.color_text : global_colors.color_text_dimmer, id_split[0], vec2{0, 0}, font});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 1, draw_pos.y + 1}, androidgui_render_type::androidgui_filled_rect, value ? global_colors.control_active_or_clicked : global_colors.control_idle, "", {control_width - 2, control_height - 2}});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y}, androidgui_render_type::androidgui_filled_rect, global_colors.control_outline, "", {control_width, control_height}});
...
// ========================================================================
void androidgui::combobox(const char *id, std::vector<std::string> items, int &value) {
    std::vector<std::string> id_split = utils::hash::split_str(id, '#');
    ...
    if (!inlined) {
        ...
        window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y - 4}, androidgui_render_type::androidgui_text, global_colors.color_text, id_split[0], vec2{0, 0}, font});

        draw_pos.y += text_height;
    }

    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + control_width - 10, draw_pos.y + 4}, androidgui_render_type::androidgui_text, global_colors.color_text, "+", vec2{0, 0}, font});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 4, draw_pos.y + 4}, androidgui_render_type::androidgui_text, global_colors.color_text, items.at(value), vec2{0, 0}, font});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 1, draw_pos.y + 1}, androidgui_render_type::androidgui_filled_rect, global_colors.control_idle, "", {control_width - 2, control_height - 2}});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y}, androidgui_render_type::androidgui_filled_rect, global_colors.control_outline, "", {control_width, control_height}});
    ...
    if (const bool hovered = utils::input::mouse_in_region(draw_pos.x, draw_pos.y, control_width, control_height); hovered && utils::input::key_pressed(VK_LBUTTON) && window_ctx.blocking == 0) {
        ...
        for (int i = 1; i <= items.size(); i++) {
            ...
            window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 4, draw_pos.y + (control_height - 1) * i + 4}, androidgui_render_type::androidgui_text, selected ? global_colors.control_active_or_clicked : global_colors.color_text, items.at(i - 1), vec2{0, 0}, font});
            window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 1, draw_pos.y + (19 * i) + 1}, androidgui_render_type::androidgui_filled_rect, hovered ? global_colors.color_combo_bg : global_colors.control_idle, "", {control_width - 2, control_height - 2}});
            window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y + 19 * i}, androidgui_render_type::androidgui_filled_rect, global_colors.control_outline, "", {control_width, control_height}});
        }
    }
...
// ========================================================================
void androidgui::multi_combobox(const char *id, std::vector<multi_select_item> items) {
    std::vector<std::string> id_split = utils::hash::split_str(id, '#');
    ...
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + control_width - 10, draw_pos.y + 4}, androidgui_render_type::androidgui_text, global_colors.color_text, "+", vec2{0, 0}, font});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 4, draw_pos.y + 4}, androidgui_render_type::androidgui_text, global_colors.color_text, value_str, vec2{0, 0}, font});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 1, draw_pos.y + 1}, androidgui_render_type::androidgui_filled_rect, global_colors.control_idle, "", {control_width - 2, control_height - 2}});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y}, androidgui_render_type::androidgui_filled_rect, global_colors.control_outline, "", {control_width, control_height}});
    ...
    if (const bool hovered = utils::input::mouse_in_region(draw_pos.x, draw_pos.y, control_width, control_height); hovered && utils::input::key_pressed(VK_LBUTTON) && window_ctx.blocking == 0) {
        ...
        for (int i = 1; i <= items.size(); i++) {
            ...
            window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 4, draw_pos.y + (control_height - 1) * i + 4}, androidgui_render_type::androidgui_text, selected ? global_colors.control_active_or_clicked : global_colors.color_text, items[i - 1].name.data(), vec2{0, 0}, font});
            window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 1, draw_pos.y + (19 * i) + 1}, androidgui_render_type::androidgui_filled_rect, hovered ? global_colors.color_combo_bg : global_colors.control_idle, "", {control_width - 2, control_height - 2}});
            window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y + 19 * i}, androidgui_render_type::androidgui_filled_rect, global_colors.control_outline, "", {control_width, control_height}});
        }
    }
...
// ========================================================================
void androidgui::begin_groupbox(std::string_view title, const vec2 size, const int flags) {
    const unsigned long font = utils::misc::pop_font();
    ...
    if (flags & androidgui_groupbox_flags_legacy_design) {
    ...
    utils::misc::push_cursor_pos(vec2{ cursor_pos.x + 8, cursor_pos.y + ((flags & androidgui_groupbox_flags_legacy_design) ? 0 : header_height) + 8 });

    utils::misc::push_font(font);
}

// ========================================================================
void androidgui::end_groupbox() {
...
// ========================================================================
void androidgui::key_bind(const char *id, int &value) {
    std::vector<std::string> id_split = utils::hash::split_str(id, '#');
    ...
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 4, draw_pos.y + 4}, androidgui_render_type::androidgui_text, global_colors.color_text, active ? "Press any key" : keys_list[value].data(), vec2{0, 0}, font});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 1, draw_pos.y + 1}, androidgui_render_type::androidgui_filled_rect, active ? global_colors.control_active_or_clicked : global_colors.control_idle, "", {control_width, control_height}});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y}, androidgui_render_type::androidgui_filled_rect, global_colors.control_outline, "", {control_width + 2, control_height + 2}});
...
// ========================================================================
void androidgui::listbox(const char *id, std::vector<multi_select_item> items) {
    std::vector<std::string> id_split = utils::hash::split_str(id, '#');
    ...
    for (int i = 1; i <= items.size(); i++) {
        ...
        window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 4, draw_pos.y + (control_height - 1) * (i - 1) + 4}, androidgui_render_type::androidgui_text, *items[i - 1].value || hovered ? global_colors.control_active_or_clicked : global_colors.color_text, items[i - 1].name.data(), vec2{0, 0}, font});
    }


    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 1, draw_pos.y + 1}, androidgui_render_type::androidgui_filled_rect, global_colors.control_idle, "", {control_width - 2, static_cast<float>(control_height * items.size() - 2)}});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y}, androidgui_render_type::androidgui_filled_rect, global_colors.control_outline, "", {control_width, static_cast<float>(control_height * items.size())}});
...
// ========================================================================
void androidgui::slider_int(const char *id, const int min, const int max, int &value) {
    std::vector<std::string> id_split = utils::hash::split_str(id, '#');
    ...
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x - (control_height - 2), draw_pos.y - 2}, androidgui_render_type::androidgui_text, global_colors.color_text_dimmer, "-", vec2{0, 0}, font});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + (control_width + 4), draw_pos.y - 2}, androidgui_render_type::androidgui_text, global_colors.color_text_dimmer, "+", vec2{0, 0}, font});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + text_x, draw_pos.y}, androidgui_render_type::androidgui_text, global_colors.color_text, value_str, vec2{0, 0}, font});

    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 1, draw_pos.y + 1}, androidgui_render_type::androidgui_filled_rect, global_colors.color_slider, "", {static_cast<float>(dynamic_width), control_height - 2}});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 1, draw_pos.y + 1}, androidgui_render_type::androidgui_filled_rect, global_colors.control_idle, "", {control_width - 2, control_height - 2}});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y}, androidgui_render_type::androidgui_filled_rect, global_colors.control_outline, "", {control_width, control_height}});
...
// ========================================================================
void androidgui::slider_float(const char *id, const float min, const float max, float &value) {
    std::vector<std::string> id_split = utils::hash::split_str(id, '#');
    ...
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 1, draw_pos.y + 1}, androidgui_render_type::androidgui_filled_rect, global_colors.color_slider, "", {dynamic_width, control_height - 2}});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 1, draw_pos.y + 1}, androidgui_render_type::androidgui_filled_rect, global_colors.control_idle, "", {control_width - 2, control_height - 2}});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y}, androidgui_render_type::androidgui_filled_rect, global_colors.control_outline, "", {control_width, control_height}});
...
// ========================================================================
bool androidgui::clickable_text(const char *id) {
    std::vector<std::string> id_split = utils::hash::split_str(id, '#');
    ...
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y}, androidgui_render_type::androidgui_text, (hovered || window_ctx.blocking == utils::hash::hash(id)) ? global_colors.control_active_or_clicked : global_colors.color_text, id_split[0], vec2{0, 0}, font});
...
// ========================================================================
void androidgui::text(const char *text) {
    const unsigned long font = utils::misc::pop_font();
    ...
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y}, androidgui_render_type::androidgui_text, global_colors.color_text, text, vec2{0, 0}, font});
...
// ========================================================================
void androidgui::text_input(const char *id, std::string &value, const int max_length, const int flags) {
    std::vector<std::string> id_split = utils::hash::split_str(id, '#');
    ...
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 4, draw_pos.y + 4}, androidgui_render_type::androidgui_text, global_colors.color_text, flags & androidgui_text_input_flags_password ? std::string(value.length(), '*').c_str() : value.c_str(), vec2{0, 0}, font});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 1, draw_pos.y + 1}, androidgui_render_type::androidgui_filled_rect, active ? global_colors.control_active_or_clicked : global_colors.control_idle, "", {control_width - 2, control_height - 2}});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y}, androidgui_render_type::androidgui_filled_rect, global_colors.control_outline, "", {control_width, control_height}});
...
// ========================================================================
void androidgui::toggle_button(const char *id, const vec2 size, bool &value) {
    std::vector<std::string> id_split = utils::hash::split_str(id, '#');
    ...
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + size.x / 2 - text_width / 2, draw_pos.y + size.y / 2 - text_height / 2}, androidgui_render_type::androidgui_text, global_colors.color_text, id_split[0], vec2{0, 0}, font});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x + 1, draw_pos.y + 1}, androidgui_render_type::androidgui_filled_rect, value ? global_colors.control_active_or_clicked : global_colors.control_idle, "", size});
    window_ctx.render.emplace_back(androidgui_control_render_t{{draw_pos.x, draw_pos.y}, androidgui_render_type::androidgui_filled_rect, global_colors.control_outline, "", {size.x + 2, size.y + 2}});
...
// ========================================================================
bool androidgui::begin_window(std::string_view title, const vec2 windowsize, const int MenuToggleKey, const int flags) {
    if (!input_loop_started)
        throw std::exception("Input loop didnt start or didnt start properly.");;

    printf("\BEGGINING WINDOW..");
   // window_ctx.position.x = 300;
   // window_ctx.position.y = 300;


    if (!(flags & androidgui_window_flags_always_open)) {
    ...
    if (const int prev_alpha = window_ctx.alpha; !(flags & androidgui_window_flags_no_ontoggle_animation)) {
    ...
    if (window_ctx.opened || window_ctx.alpha > 0) {
        if (!(flags & androidgui_window_flags_no_move)) {
            if ((flags & androidgui_window_flags_no_border ? utils::input::mouse_in_region(window_ctx.position.x + 9, window_ctx.position.y + 14, window_ctx.size.x - 18, 14)
        ...
        if (!(flags & androidgui_window_flags_no_border)) {
        ...
        if (!(flags & androidgui_window_flags_no_titlebar)) {
            int text_width, text_height;
            functions.get_text_size(title.data(), text_width, text_height);
    ...
    for (int i = window_ctx.render.size() - 1; i >= 0; i--) {
        switch (window_ctx.render[i].render_type) {
            case androidgui_render_type::androidgui_line:
                ...
                break;
            case androidgui_render_type::androidgui_rect:
                ...
                break;
            case androidgui_render_type::androidgui_filled_rect:
                ...
                break;
            case androidgui_render_type::androidgui_text:
...
// ========================================================================
void androidgui::separator(int space, bool invisible){
    const vec2 cursor_pos = utils::misc::pop_cursor_pos();
    utils::misc::push_cursor_pos(vec2{cursor_pos.x, cursor_pos.y + space });
}

// ========================================================================
void androidgui::next_column(const int pusher_x, const int pusher_y) {
    const vec2 cursor_pos = utils::misc::pop_cursor_pos();
...
void androidgui::SetWidgetPosition(const int x, const int y) {
    const vec2 cursor_pos = utils::misc::pop_cursor_pos();
...
// ========================================================================
void androidgui::back_column(const int back_x, const int back_y) {
    const vec2 cursor_pos = utils::misc::pop_cursor_pos();
...
// ========================================================================
void androidgui::same_line(const float x_axis) {
    const vec2 cursor_pos = utils::misc::pop_cursor_pos();
...
// ========================================================================
std::vector<std::string> androidgui::utils::hash::split_str(const char *str, const char separator) {
...
// ========================================================================
uint32_t androidgui::utils::hash::hash(const char *str, const uint32_t value) {
...
void androidgui::window_input(LPCWSTR windowname, LPCWSTR classname) {
    ...
    ScreenToClient(FindWindowW(windowname, classname), &p_mouse_pos);
...
// ========================================================================
// Function for starting our input loop.
void androidgui::poll_input(HWND hwnd) {
    if (!hwnd)
...
// ========================================================================
bool androidgui::utils::input::key_pressed(const int key) {
    return key_state[key] && !prev_key_state[key];
}

// ========================================================================
bool androidgui::utils::input::key_down(const int key) {
    return key_state[key];
}

// ========================================================================
bool androidgui::utils::input::key_released(const int key) {
    return !key_state[key] && prev_key_state[key];
}

// ========================================================================
// Check if mouse is hovered over specified region.
bool androidgui::utils::input::mouse_in_region(const int x, const int y, const int w, const int h) {
...
void androidgui::utils::misc::push_cursor_pos(const vec2 pos) {
    window_ctx.cursor_pos.push(pos);
}

// ========================================================================
// Pop cursor position from the stack defined in window context.
androidgui::vec2 androidgui::utils::misc::pop_cursor_pos() {
...
void androidgui::utils::misc::push_font(const unsigned long font) {
    window_ctx.fonts.push(font);
}

// ========================================================================
// Push font to the stack defined in window context.
unsigned long androidgui::utils::misc::pop_font() {
